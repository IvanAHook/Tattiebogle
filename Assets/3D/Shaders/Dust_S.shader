...
/////// Diffuse:
                ...
                float3 diffuseColor = (_node_8949.rgb*_node_64_var.rgb);
                float3 diffuse = (directDiffuse + indirectDiffuse) * diffuseColor;
/// Final Color:
                float3 finalColor = diffuse;
                fixed4 finalRGBA = fixed4(finalColor,_node_64_var.a);
...
/// Final Color:
                float3 finalColor = diffuse;
                return fixed4(finalColor * _node_64_var.a,0);
            }
            ENDCG
        }
    }

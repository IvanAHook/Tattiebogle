...
/*SF_DATA;ver:1.13;sub:START;pass:START;ps:flbk:,lico:1,lgpr:1,nrmq:1,nrsp:0,limd:1,spmd:1,trmd:0,grmd:0,uamb:True,mssp:True,bkdf:False,rprd:False,enco:False,rmgx:True,rpth:0,hqsc:True,hqlp:False,tesm:0,bsrc:3,bdst:7,culm:0,dpts:2,wrdp:False,dith:0,ufog:True,aust:True,igpj:True,qofs:0,qpre:3,rntp:2,fgom:False,fgoc:False,fgod:False,fgor:False,fgmd:0,fgcr:0.5,fgcg:0.5,fgcb:0.5,fgca:1,fgde:0.01,fgrn:0,fgrf:300,ofsf:0,ofsu:0,f2p0:False;n:type:ShaderForge.SFN_Final,id:2045,x:32719,y:32712,varname:node_2045,prsc:2|diff-4850-OUT,alpha-5994-OUT;n:type:ShaderForge.SFN_Tex2d,id:64,x:32198,y:32759,ptovrint:False,ptlb:node_64,ptin:_node_64,varname:_node_64,prsc:2,tex:6414663ef32d2cb469431860e52ee2c6,ntxv:0,isnm:False;n:type:ShaderForge.SFN_Color,id:8949,x:32264,y:32540,ptovrint:False,ptlb:node_8949,ptin:_node_8949,varname:_node_8949,prsc:2,glob:False,c1:0.5,c2:0.5,c3:0.5,c4:1;n:type:ShaderForge.SFN_Multiply,id:4850,x:32473,y:32636,varname:node_4850,prsc:2|A-8949-RGB,B-64-RGB,C-2523-RGB;n:type:ShaderForge.SFN_VertexColor,id:2523,x:32371,y:33027,varname:node_2523,prsc:2;n:type:ShaderForge.SFN_Multiply,id:5994,x:32506,y:32838,varname:node_5994,prsc:2|A-64-A,B-2523-A;proporder:64-8949;pass:END;sub:END;*/
...
/// Final Color:
                ...
                fixed4 finalRGBA = fixed4(finalColor,(_node_64_var.a*i.vertexColor.a));
...
/// Final Color:
                float3 finalColor = diffuse;
                return fixed4(finalColor * (_node_64_var.a*i.vertexColor.a),0);
            }
            ENDCG
        }
    }

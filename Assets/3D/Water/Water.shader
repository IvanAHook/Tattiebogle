...
/*SF_DATA;ver:1.13;sub:START;pass:START;ps:flbk:,lico:1,lgpr:1,nrmq:1,nrsp:0,limd:1,spmd:1,trmd:0,grmd:0,uamb:True,mssp:True,bkdf:False,rprd:False,enco:False,rmgx:True,rpth:0,hqsc:True,hqlp:False,tesm:0,bsrc:3,bdst:7,culm:0,dpts:2,wrdp:False,dith:0,ufog:True,aust:True,igpj:True,qofs:0,qpre:3,rntp:2,fgom:False,fgoc:False,fgod:False,fgor:False,fgmd:0,fgcr:0.9558824,fgcg:0.5693123,fgcb:0.9292224,fgca:1,fgde:0.05,fgrn:0,fgrf:300,ofsf:0,ofsu:0,f2p0:False;n:type:ShaderForge.SFN_Final,id:7771,x:33564,y:32344,varname:node_7771,prsc:2|diff-6613-OUT,spec-4669-OUT,normal-7789-OUT,voffset-3085-OUT;n:type:ShaderForge.SFN_Tex2d,id:3314,x:32618,y:32858,varname:node_3314,prsc:2,ntxv:3,isnm:True|UVIN-7836-UVOUT,TEX-1959-TEX;n:type:ShaderForge.SFN_Color,id:440,x:33089,y:31919,ptovrint:False,ptlb:Diffuse,ptin:_Diffuse,varname:node_440,prsc:2,glob:False,c1:0.5,c2:0.5,c3:0.5,c4:1;n:type:ShaderForge.SFN_Color,id:6679,x:32649,y:32680,ptovrint:False,ptlb:Spec,ptin:_Spec,varname:_Diffuse_copy,prsc:2,glob:False,c1:0.5,c2:0.5,c3:0.5,c4:1;n:type:ShaderForge.SFN_Panner,id:7836,x:32377,y:32805,varname:node_7836,prsc:2,spu:0.1,spv:1|UVIN-4571-UVOUT,DIST-4288-OUT;n:type:ShaderForge.SFN_Slider,id:4078,x:31847,y:32809,ptovrint:False,ptlb:Speed1,ptin:_Speed1,varname:node_4078,prsc:2,min:-1,cur:0.2,max:1;n:type:ShaderForge.SFN_Time,id:9153,x:31938,y:32925,varname:node_9153,prsc:2;n:type:ShaderForge.SFN_Multiply,id:4288,x:32214,y:32929,varname:node_4288,prsc:2|A-4078-OUT,B-9153-T;n:type:ShaderForge.SFN_Tex2dAsset,id:1959,x:32417,y:33037,ptovrint:False,ptlb:Wave,ptin:_Wave,varname:node_1959,glob:False,ntxv:3,isnm:True;n:type:ShaderForge.SFN_Tex2d,id:6833,x:32658,y:33086,varname:node_6833,prsc:2,ntxv:0,isnm:False|UVIN-5010-UVOUT,TEX-1959-TEX;n:type:ShaderForge.SFN_Slider,id:2451,x:31806,y:33253,ptovrint:False,ptlb:Speed2,ptin:_Speed2,varname:_Speed2,prsc:2,min:-1,cur:-0.2,max:1;n:type:ShaderForge.SFN_Multiply,id:4932,x:32194,y:33268,varname:node_4932,prsc:2|A-9153-T,B-2451-OUT;n:type:ShaderForge.SFN_Panner,id:5010,x:32384,y:33243,varname:node_5010,prsc:2,spu:0.1,spv:1|UVIN-8029-OUT,DIST-4932-OUT;n:type:ShaderForge.SFN_NormalBlend,id:7789,x:32837,y:32880,varname:node_7789,prsc:2|BSE-3314-RGB,DTL-6833-RGB;n:type:ShaderForge.SFN_Multiply,id:8029,x:32214,y:33123,varname:node_8029,prsc:2|A-4571-UVOUT,B-340-OUT;n:type:ShaderForge.SFN_TexCoord,id:4571,x:31892,y:33081,varname:node_4571,prsc:2,uv:0;n:type:ShaderForge.SFN_ValueProperty,id:340,x:31884,y:33459,ptovrint:False,ptlb:Tiling2,ptin:_Tiling2,varname:node_340,prsc:2,glob:False,v1:0;n:type:ShaderForge.SFN_Vector3,id:8144,x:32643,y:33609,varname:node_8144,prsc:2,v1:0,v2:1,v3:0;n:type:ShaderForge.SFN_Multiply,id:8349,x:33092,y:33320,varname:node_8349,prsc:2|A-6833-G,B-8144-OUT;n:type:ShaderForge.SFN_Multiply,id:3085,x:32643,y:33403,varname:node_3085,prsc:2|A-7910-OUT,B-8144-OUT,C-354-OUT;n:type:ShaderForge.SFN_Tex2d,id:4182,x:32153,y:33459,varname:node_4182,prsc:2,ntxv:0,isnm:False|UVIN-8626-UVOUT,TEX-2860-TEX;n:type:ShaderForge.SFN_Slider,id:354,x:32440,y:33772,ptovrint:False,ptlb:OffsetHeight,ptin:_OffsetHeight,varname:node_354,prsc:2,min:0,cur:0,max:1;n:type:ShaderForge.SFN_Panner,id:8626,x:32128,y:33698,varname:node_8626,prsc:2,spu:1,spv:1|DIST-8202-OUT;n:type:ShaderForge.SFN_Slider,id:526,x:31599,y:33737,ptovrint:False,ptlb:OffsetSpeed,ptin:_OffsetSpeed,varname:node_526,prsc:2,min:0,cur:0,max:1;n:type:ShaderForge.SFN_Multiply,id:8202,x:31960,y:33622,varname:node_8202,prsc:2|A-9153-T,B-526-OUT;n:type:ShaderForge.SFN_Subtract,id:7910,x:32383,y:33508,varname:node_7910,prsc:2|A-4182-B,B-1277-OUT;n:type:ShaderForge.SFN_Vector1,id:1277,x:32313,y:33698,varname:node_1277,prsc:2,v1:0.5;n:type:ShaderForge.SFN_Tex2d,id:9460,x:32393,y:32255,varname:node_9460,prsc:2,ntxv:0,isnm:False|UVIN-1033-UVOUT,TEX-2860-TEX;n:type:ShaderForge.SFN_Color,id:9846,x:32978,y:32322,ptovrint:False,ptlb:FoamColor,ptin:_FoamColor,varname:node_9846,prsc:2,glob:False,c1:0.5,c2:0.5,c3:0.5,c4:1;n:type:ShaderForge.SFN_Lerp,id:6613,x:33265,y:32255,varname:node_6613,prsc:2|A-440-RGB,B-9846-RGB,T-2-OUT;n:type:ShaderForge.SFN_Multiply,id:5021,x:32937,y:32674,varname:node_5021,prsc:2|A-34-OUT,B-6679-RGB;n:type:ShaderForge.SFN_OneMinus,id:34,x:32809,y:32507,varname:node_34,prsc:2|IN-9460-R;n:type:ShaderForge.SFN_Panner,id:1033,x:32134,y:32350,varname:node_1033,prsc:2,spu:0,spv:1|DIST-2430-OUT;n:type:ShaderForge.SFN_Slider,id:4153,x:31663,y:32241,ptovrint:False,ptlb:FoamEdgeSpeed,ptin:_FoamEdgeSpeed,varname:node_4153,prsc:2,min:-1,cur:0.2,max:1;n:type:ShaderForge.SFN_Multiply,id:2430,x:31962,y:32488,varname:node_2430,prsc:2|A-4153-OUT,B-9153-T;n:type:ShaderForge.SFN_Tex2dAsset,id:2860,x:32154,y:32114,ptovrint:False,ptlb:Foam,ptin:_Foam,varname:node_2860,glob:False,ntxv:0,isnm:False;n:type:ShaderForge.SFN_Tex2d,id:2293,x:32393,y:32005,varname:node_2293,prsc:2,ntxv:0,isnm:False|UVIN-6720-UVOUT,TEX-2860-TEX;n:type:ShaderForge.SFN_Slider,id:5480,x:31663,y:32093,ptovrint:False,ptlb:FoamCenterSpeed,ptin:_FoamCenterSpeed,varname:_FoamEdgeSpeed_copy,prsc:2,min:-1,cur:0.2,max:1;n:type:ShaderForge.SFN_Multiply,id:6139,x:32013,y:31992,varname:node_6139,prsc:2|A-5480-OUT,B-9153-T;n:type:ShaderForge.SFN_Panner,id:6720,x:32195,y:31904,varname:node_6720,prsc:2,spu:0,spv:1|DIST-6139-OUT;n:type:ShaderForge.SFN_Multiply,id:4396,x:32683,y:31959,varname:node_4396,prsc:2|A-8530-OUT,B-2293-G,C-1242-OUT;n:type:ShaderForge.SFN_OneMinus,id:8530,x:32492,y:31836,varname:node_8530,prsc:2|IN-2293-R;n:type:ShaderForge.SFN_Multiply,id:4233,x:32683,y:32165,varname:node_4233,prsc:2|A-9460-R,B-9460-G,C-6896-OUT,D-7260-G;n:type:ShaderForge.SFN_Add,id:9886,x:32918,y:32070,varname:node_9886,prsc:2|A-4396-OUT,B-4233-OUT;n:type:ShaderForge.SFN_Clamp01,id:2,x:33099,y:32128,varname:node_2,prsc:2|IN-9886-OUT;n:type:ShaderForge.SFN_Slider,id:6896,x:32514,y:32367,ptovrint:False,ptlb:EdgeFoam,ptin:_EdgeFoam,varname:node_6896,prsc:2,min:0,cur:0,max:1;n:type:ShaderForge.SFN_Slider,id:1242,x:32645,y:31802,ptovrint:False,ptlb:CenterFoam,ptin:_CenterFoam,varname:node_1242,prsc:2,min:0,cur:1,max:1;n:type:ShaderForge.SFN_OneMinus,id:4669,x:33614,y:32102,varname:node_4669,prsc:2|IN-6073-OUT;n:type:ShaderForge.SFN_ComponentMask,id:6073,x:33433,y:32102,varname:node_6073,prsc:2,cc1:1,cc2:-1,cc3:-1,cc4:-1|IN-6613-OUT;n:type:ShaderForge.SFN_Tex2d,id:7260,x:32349,y:32419,ptovrint:False,ptlb:FoamMask,ptin:_FoamMask,varname:node_7260,prsc:2,ntxv:0,isnm:False|UVIN-707-UVOUT;n:type:ShaderForge.SFN_Panner,id:707,x:32204,y:32563,varname:node_707,prsc:2,spu:1,spv:1|DIST-9963-OUT;n:type:ShaderForge.SFN_Slider,id:7358,x:31748,y:32688,ptovrint:False,ptlb:FoamMaskSpeed,ptin:_FoamMaskSpeed,varname:node_7358,prsc:2,min:-1,cur:0,max:1;n:type:ShaderForge.SFN_Multiply,id:9963,x:32063,y:32630,varname:node_9963,prsc:2|A-9153-T,B-7358-OUT;proporder:6679-440-4078-1959-2451-340-354-526-9846-4153-2860-5480-6896-1242-7260-7358;pass:END;sub:END;*/

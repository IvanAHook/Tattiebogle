...
Shader "Shader Forge/Water" {
    Properties {
        ...
        _CenterFoam ("CenterFoam", Range(0, 1)) = 0
    }
    SubShader {
        Tags {
...
/////// Vectors:
                ...
                float3 normalLocal = lerp(node_7789,i.normalDir,node_9460.r);
...
////// Specular:
                ...
                float3 node_6613 = lerp(_Diffuse.rgb,_FoamColor.rgb,saturate((((1.0 - node_2293.r)*node_2293.g*_CenterFoam)+(node_9460.r*node_9460.g*_EdgeFoam))));
